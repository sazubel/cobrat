...
$(document).ready(function(){
 $("#f_var_dni").blur(function(){
  ...
  $.ajax({
   type: "POST",
   url: "<?php echo base_url();?>index.php/controladores-admin/controlador_administracion_clientes/validar_dni2",
...
echo form_open('controladores-admin/controlador_administracion_clientes/agregar_cliente', $attributes);   ?>                     
                        
<!--<form class="form uniformForm validateForm" action="<?php //echo base_url();?>index.php/controladores-admin/controlador_administracion_clientes/agregar_cliente">-->
