...
$(document).ready(function(){	
		$( "#confirmacion" ).dialog({
			  ...
			  buttons: {
				"Aceptar": function() {
				  document.location ='/index.php/controladores-cobrador/controlador_administracion/salir';
				},
				Cancel: function() {
				  $( this ).dialog( "close" );
				}
 ...
 <div id="confirmacion" title="ADVERTENCIA">
	<p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 10px 20px 0;"></span>Seguro que desea Salir del programa?</p>
</div>
