...
<tr class="gradeA">
    ...
    <td><?php  
			if ($atraso <= 0){
				echo "<span class='ticket ticket-success'>sin atraso</span>";
			} else {
		...
		?></td>
	<td>
	<?php echo $row->tipos_de_creditos.' -> '.$row->cantidad_cuotas.' Cuotas x $ '.$row->monto_cuota ?>
    </td>
    <td>
	<?php 
			if ($atraso <= 0){
