...
[];wa(a,c);a.fnServerData.call(a.oInstance,a.sAjaxSource,c,function(e){var f=a.sAjaxDataProp!==""?ia(a.sAjaxDataProp)(e):e;for(b=0;b<f.length;b++)P(a,f[b]);a.iInitDisplayStart=d;if(a.oFeatures.bSort)X(a);else{a.aiDisplay=a.aiDisplayMaster.slice();J(a);H(a)}O(a,false);ma(a,e)},a)}else if(!a.oFeatures.bServerSide){O(a,false);ma(a)}}}function ma(a,b){a._bInitComplete=true;L(a,"aoInitComplete","init",[a,b])}function Ca(a){var b=l.defaults.oLanguage;!a.sEmptyTable&&a.sZeroRecords&&b.sEmptyTable==="No hay datos para mostrar"&&
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"No hay datos para mostrar",sInfo:"Mostrando desde _START_ a _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrando de 0 a 0 de 0 entradas",sInfoFiltered:"(filtrando de _MAX_ entradas)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Mostrar _MENU_ entradas",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sUrl:"",sZeroRecords:"No se encuentran registros"},oSearch:i.extend({},l.models.oSearch),sAjaxDataProp:"aaData",
