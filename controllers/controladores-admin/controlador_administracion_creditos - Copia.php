...
{		
	//if($this->session->userdata('permiso_usuario')!=1) { redirect('controlador_administracion/cerrar_cession'); }
		...
		$this->form_validation->set_rules('f_var_detalle_credito', 'Detalle', 'required');
		...
		if ($this->form_validation->run() == FALSE)//validacion del formulario
			{
				...
				$data['main_content']="administracion/pagina_agregar_credito";
			...
			$f_var_notas_complementarias = $this -> input -> post('f_var_notas_complementarias');
			...
			$formulario_creditos = array(
				...
				'fecha_proximo_pago'=> $f_var_fecha_1er_pago,
				'fecha_fin_credito'=> $fecha_fin_credito,
				'estado_credito'=> $estado_credito,
				'notas_complementarias'=> $f_var_notas_complementarias,
			...
			//$this -> modelo_creditos -> alta_de_credito($f_var_id_usuario,$f_var_id_cliente,$f_var_tipo_credito,$f_var_cant_cuotas,$f_var_monto_cuota,$f_var_monto_prestamo,$f_var_detalle_credito,$f_var_fecha_entrega,$f_var_fecha_1er_pago,$fecha_fin_credito,$f_var_notas_complementarias,$f_var_id_zona_cobros,$f_var_id_dia_cobranza);
				...
				<div class='notify notify-success'>
						...
						<p>El credito se ha registrado con exito y la primer cuota se debera pagar el dia (aaaa/mm/dd): <span class='ticket ticket-important'>$f_var_fecha_1er_pago</span></p>
...
{	
				...
				$data['admin_menu_top']="administracion/admin_menu_top";
				//$data['navegacion_rapida']="administrador/pagina_admin_navagacion_rapida";
				$data['main_content']="administracion/pagina_listar_creditos";
				$data['boton_destacado']=3;//destaco el primer boton en la botonera de la derecha
