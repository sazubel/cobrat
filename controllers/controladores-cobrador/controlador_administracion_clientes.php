		...
		if ($this->form_validation->run() == FALSE)//validacion del formulario
			{
				...
				$data['main_content']="administracion-cobrador/pagina_agregar_clientes";
			...
			//echo ('LOS DATOS INGRESADOS SON CORRECTOS');
				$data['titulo_pagina']="Sistema de administracion-cobrador - Agregar Clientes al Sistema";
				$data['sidebar_botonera']="administracion-cobrador/admin_sidebar_menu";
				$data['admin_menu_top']="administracion-cobrador/admin_menu_top";
				//$data['navegacion_rapida']="administrador/pagina_admin_navagacion_rapida";
				$data['main_content']="administracion-cobrador/pagina_agregar_clientes";
...
{	
				...
				$data['titulo_pagina']="Sistema de administracion-cobrador - Clientes";
				$data['sidebar_botonera']="administracion-cobrador/admin_sidebar_menu";
				$data['admin_menu_top']="administracion-cobrador/admin_menu_top";
				//$data['navegacion_rapida']="administrador/pagina_admin_navagacion_rapida";
				$data['main_content']="administracion-cobrador/pagina_listar_clientes";
				$data['boton_destacado']=2;//destaco el primer boton en la botonera de la derecha
